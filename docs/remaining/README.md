...
Когда чеклист шага 9 закрыт — продолжение на FastAPI: [../fastapi/README.md](../fastapi/README.md). Затем Docker: [../docker/README.md](../docker/README.md). Затем Celery: [../celery/README.md](../celery/README.md). Затем pytest: [../pytest/README.md](../pytest/README.md).
