...
BOOKS = [
    {"title": "Пикник на обочине", "year": 1972, "author": "Аркадий Стругацкий", "genre": "фантастика"},
    {"title": "Убийство в «Восточном экспрессе»", "year": 1934, "author": "Агата Кристи", "genre": "детектив"},
    {"title": "Реквием", "year": 1963, "author": "Анна Ахматова", "genre": "поэзия"},
]
...
async def seed() -> None:
    ...
    async with session_factory() as session:
        ...
        authors = {item["name"]: Author(name=item["name"], bio=item["bio"]) for item in AUTHORS}
        ...
        print(f"Добавлено: {len(genres)} жанра, {len(authors)} автора, {len(books)} книги.")
